...
class CustomerServiceTest {
    ...
    void shouldGetCustomerSuccessfully() {
        // Given
        CustomerResponse expectedCustomer = new CustomerResponse("customer-1", "John Doe", "ACTIVE");
        
        when(webClient.get()).thenReturn(requestHeadersUriSpec);
        when(requestHeadersUriSpec.uri(anyString(), any(Object.class))).thenReturn(requestHeadersSpec);
        when(requestHeadersSpec.retrieve()).thenReturn(responseSpec);
        when(responseSpec.bodyToMono(CustomerResponse.class)).thenReturn(Mono.just(expectedCustomer));
    ...
    void shouldThrowCustomerNotFoundWhenCustomerDoesNotExist() {
        ...
        when(requestHeadersUriSpec.uri(anyString(), any(Object.class))).thenReturn(requestHeadersSpec);
        when(requestHeadersSpec.retrieve()).thenReturn(responseSpec);
        when(responseSpec.bodyToMono(CustomerResponse.class)).thenReturn(Mono.error(notFoundException));
    ...
    void shouldThrowExternalApiExceptionOnServerError() {
        ...
        when(requestHeadersUriSpec.uri(anyString(), any(Object.class))).thenReturn(requestHeadersSpec);
        when(requestHeadersSpec.retrieve()).thenReturn(responseSpec);
        when(responseSpec.bodyToMono(CustomerResponse.class)).thenReturn(Mono.error(serverErrorException));
    ...
    void shouldReturnFalseWhenCustomerIsInactive() {
        ...
        when(requestHeadersUriSpec.uri(anyString(), any(Object.class))).thenReturn(requestHeadersSpec);
        when(requestHeadersSpec.retrieve()).thenReturn(responseSpec);
        when(responseSpec.bodyToMono(CustomerResponse.class)).thenReturn(Mono.just(inactiveCustomer));
    ...
    void shouldReturnFalseWhenCustomerServiceFails() {
        ...
        when(requestHeadersUriSpec.uri(anyString(), any(Object.class))).thenReturn(requestHeadersSpec);
        when(requestHeadersSpec.retrieve()).thenReturn(responseSpec);
        when(responseSpec.bodyToMono(CustomerResponse.class)).thenReturn(Mono.error(new RuntimeException("Service error")));
