...
class ProductServiceTest {
    ...
    void shouldGetProductSuccessfully() {
        // Given
        ProductResponse expectedProduct =
    ...
    void shouldReturnTrueWhenAllProductsAreValid() {
        // Given
        ProductResponse validProduct1 =
                new ProductResponse("product-1", "Laptop", "Gaming laptop", 999.0);
        ProductResponse validProduct2 =
                new ProductResponse("product-2", "Mouse", "Gaming mouse", 50.0);
        List<String> productIds = List.of("product-1", "product-2");
