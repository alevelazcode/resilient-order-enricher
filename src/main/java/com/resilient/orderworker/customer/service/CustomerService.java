...
/**
 * Service for fetching customer information from the Go API.
...
public class CustomerService {
    ...
    public Mono<CustomerResponse> getCustomer(String customerId) {
        ...
        return webClient
            ...
            .doOnSuccess(response -> logger.debug("Successfully fetched customer: {}", customerId))
